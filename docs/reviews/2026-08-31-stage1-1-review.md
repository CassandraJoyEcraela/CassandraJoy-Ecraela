<!-- PR TARGET: https://github.com/CassandraJoyEcraela/CassandraJoy-Ecraela | Stage 1.1 -->
...
capabilities/marginal-analysis/model.xlsx exists in your repository and is a single empty sheet, and spec.md next to it is 210 bytes. That is Stage 1.2, and the order matters: the specification is written first and the workbook is built from it, not the other way around.
